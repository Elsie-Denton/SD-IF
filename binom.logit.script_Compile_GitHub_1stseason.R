...
#####
##### original author Mevin Hooten, modified by Elsie Denton
##### Date: 3 Dec 2018
...
####
#### call up data from below to use and create percent alive column
####

AGCR.plot$palive17<-AGCR.plot$Alive.17/AGCR.plot$Count.17
PSSP.plot$palive17<-PSSP.plot$Alive.17/PSSP.plot$Count.17
POSE.plot$palive17<-POSE.plot$Alive.17/POSE.plot$Count.17


###
### 2017, first season survival
###
...
Y.AGCR=AGCR.plot$Alive.17
n.AGCR=AGCR.plot$Count.17
TRT.AGCR=AGCR.plot$Trt
S2.AGCR=sd(AGCR.plot$Alive.17/AGCR.plot$Count.17)^2
T2=2
its=20000
S2.AGCR
...
Y.PSSP=PSSP.plot$Alive.17
n.PSSP=PSSP.plot$Count.17
TRT.PSSP=PSSP.plot$Trt
S2.PSSP=sd(PSSP.plot$Alive.17/PSSP.plot$Count.17)^2
T2=2
its=20000
...
Y.POSE=POSE.plot$Alive.17
n.POSE=POSE.plot$Count.17
TRT.POSE=POSE.plot$Trt
S2.POSE=sd(POSE.plot$Alive.17/POSE.plot$Count.17)^2
T2=2
its=20000
